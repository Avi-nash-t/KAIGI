...
const CallList: React.FC<CallListProps> = ({ type }) => {
  ...
  const { endedCalls, upcommingCalls, recordings, isLoading } = useGetCalls();
  const [recordingsData, setRecordingsData] = useState<CallRecording[]>([]);
  ...
  useEffect(() => {
    const fetchRecordings = async () => {
      ...
      setRecordingsData(fetchedRecordings);
    };
